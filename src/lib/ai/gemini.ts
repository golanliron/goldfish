...
קטגוריות:
- identity: מסמכים רשמיים של העמותה — תקנון, אישור ניהול תקין, אישור ניהול ספרים, אישור סעיף 46, אישור ניכוי מס, תעודת רישום, אישור חברי ועד מנהל, אישור בעלות חשבון, פרוטוקול ועד, מצגת היכרות, תיאור ארגוני, אודות, חזון
- programs: תיאורי תוכניות, מודל הפעלה, שירותים, פעילויות, קהלי יעד
...
- submission: הגשות לקרנות, בקשות מענק, מכתבי בקשה, טפסי הגשה
- impact: דוחות אימפקט, מדידה, הערכה, סקרים, מדדי הצלחה, עדויות
- other: כל דבר שלא מתאים
