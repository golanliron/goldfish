...
1. ELIGIBILITY (משקל 25%) — האם הארגון עומד בתנאי הסף?
   ...
   100 = עומד בכל התנאים בוודאות. 0 = אסור לו להגיש.
...
חשוב: reasoning חייב להיות 2-3 משפטים ספציפיים בעברית. אל תכתוב משפטים גנריים.
ציין מה ספציפית מתאים ומה לא, לפי הנתונים שניתנו.
